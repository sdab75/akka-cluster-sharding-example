 ...
 */
public class MyEntitySupervisor extends UntypedActor {

    LoggingAdapter log = Logging.getLogger(getContext().system(), this);

    private final ActorRef myEntity = getContext().actorOf(Props.create(akka.cluster.sharding.example.app.MyEntity.class), "myEntity");
